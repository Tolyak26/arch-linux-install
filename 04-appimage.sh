...
cp -v $scriptdir/desktop-files/yuzu-ea.desktop /usr/share/applications/yuzu-ea.desktop
...
cp -v $scriptdir/desktop-files/yuzu-mainline.desktop /usr/share/applications/yuzu-mainline.desktop
...
cp -v $scriptdir/desktop-files/moondeckbuddy.desktop /usr/share/applications/moondeckbuddy.desktop
