...
then
    $scriptdir/arch-linux-install/01-pre-setup.sh 2>&1 | tee -a 01-pre-setup.log
else
...
if [[ "$1" == "--debug" ]] || [[ "$1" == "-dbg" ]] || [[ "$1" == "debug" ]] || [[ "$1" == "dbg" ]];
then
    arch-chroot /mnt /root/arch-linux-install/02-setup.sh 2>&1 | tee -a 02-setup.log
else
...
if [[ "$1" == "--debug" ]] || [[ "$1" == "-dbg" ]] || [[ "$1" == "debug" ]] || [[ "$1" == "dbg" ]];
then
    arch-chroot /mnt /usr/bin/runuser -u $username -- /home/$username/arch-linux-install/03-aur.sh 2>&1 | tee -a 03-aur.log
else
...
if [[ "$1" == "--debug" ]] || [[ "$1" == "-dbg" ]] || [[ "$1" == "debug" ]] || [[ "$1" == "dbg" ]];
then
    arch-chroot /mnt /root/arch-linux-install/04-appimage.sh 2>&1 | tee -a 04-appimage.log
else
...
if [[ "$1" == "--debug" ]] || [[ "$1" == "-dbg" ]] || [[ "$1" == "debug" ]] || [[ "$1" == "dbg" ]];
then
    arch-chroot /mnt /root/arch-linux-install/05-post-setup.sh 2>&1 | tee -a 05-post-setup.log
else
